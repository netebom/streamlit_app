...
def home():
    ...
    # Add a visual
    image_path = os.path.join(os.getcwd(), 'utils', 'churn.webp')
    st.image(image_path, use_container_width=True, caption="Predicting customer churn to retain valuable customers.")
...
st.markdown("""
For collaboration or support, please contact Etebom.
""")
