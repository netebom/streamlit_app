...
def main():
    ...
    if choice == "Home":
        st.subheader("Home")
        st.write("Welcome to the app! Please log in to access the features.")
    ...
    if "logged_in" in st.session_state and st.session_state["logged_in"]:
        ...
        # Add your app content here for logged-in users
        st.write("You can now access the restricted content!")
    else:
